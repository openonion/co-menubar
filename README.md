...
Download `OOMenuBar.app` from [Releases](https://github.com/openonion/oo-menubar/releases), drag to `/Applications`, open it.
...
- The `co` CLI binary is compiled with PyInstaller and embedded in `OOMenuBar.app/Contents/Resources/co`
